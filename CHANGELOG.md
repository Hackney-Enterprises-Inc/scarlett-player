...
- `packages/plugins/<name>/CHANGELOG.md` for each plugin

Release notes for every version are also on the
[GitHub releases page](https://github.com/Hackney-Enterprises-Inc/scarlett-player/releases).
