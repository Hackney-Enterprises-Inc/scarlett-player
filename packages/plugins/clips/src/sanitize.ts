 ...
 * Icon sanitisation.
 *
 * Copied verbatim from `@scarlett-player/share` (whose package doc the plan
 * points ClipButton's `buttonIcon` handling at): "as in share" means the
 * same trusted-host-with-a-CMS-field hazard, so it gets the same defence.
 *
