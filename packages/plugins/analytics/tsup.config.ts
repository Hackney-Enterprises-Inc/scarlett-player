...
/**
 * tsup build for @scarlett-player/analytics.
 *
 ...
 * `__PKG_VERSION__`, and the plugin reports it both on its descriptor and as
 * the `playerVersion` on every beacon, replacing the hand-written '0.1.0' that
 * had drifted from the published 1.7.0.
 *
