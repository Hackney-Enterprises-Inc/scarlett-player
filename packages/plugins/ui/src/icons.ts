 ...
 *
 * The three glyphs `audio-ui` draws identically come from core's
 * `SHARED_ICON_PATHS`; the `<svg>` wrapper stays here because this package
 * paints with `fill="currentColor"` and `audio-ui` does not.
 */
